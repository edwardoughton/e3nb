...
plot =
  ...
  labs(title="(A) Simulation Results for Required Fresnel Clearance Values",
  colour=NULL,
...
plot2 = 
  ...
  geom_boxplot() + geom_jitter(width = 0.5, size=.05, alpha=.2) +
  labs(title="(B) Simulation Results for the Received Signal based on the FSPL",
       colour=NULL,
       subtitle = "Reported for all frequency and distance categories",
